    ...
    <div className='money-container'>
      <div className='money-box'>
        ...
        <div className='money2' >
          <img src={process.env.PUBLIC_URL + '/img/subaccount.png'} alt="subaccount" href="#" style={{marginTop: "70px"}} />
          <h2 style={{marginTop: "20px"}}><strong>적금</strong></h2>
